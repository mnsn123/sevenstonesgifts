(function( $ ) {
	...
	$.Shop.prototype = {
		init: function() {
			...
			this.cartPrefix = "Monsoon-https://monsoonmalabar.com/sevenstonesgifts-"; // Prefix string to be prepended to the cart's name in the session storage
		...
		sendEmail: function() {
			if( this.$checkoutCart.length && this.$userDetails.length ) {
				...
				if( items.length == 0 ) {
					...
					var uemail = 'sevenstones2k21@gmail.com';
